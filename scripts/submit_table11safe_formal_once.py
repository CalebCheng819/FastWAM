...
COMMIT = "3e7c03909c21b945446a6937c4d42287758bb498"
IMAGE = (
...
REAL_DATA_PREFLIGHT = LAUNCH_ROOT / "preflight-terminal-reconciliation-r5.json"
OUTPUT_DIR = f"/oss-chengjuntao/artifacts/{RUN_ID}"
REAL_DATA_PREFLIGHT_RUN_ID = (
    "fastwam-table11safe-vg1h1gau1-scratch-preflight-s42-8g-r5-20260830"
)
REAL_DATA_PREFLIGHT_ATTEMPT_ID = "attempt-r5-20260830"
REAL_DATA_PREFLIGHT_OUTPUT_DIR = (
    f"/oss-chengjuntao/artifacts/{REAL_DATA_PREFLIGHT_RUN_ID}"
)
BUNDLE = str(LAUNCH_ROOT / "fastwam-table11safe-scratch50k-source-r6-20260830.bundle")
DATASET_ROOT = (
