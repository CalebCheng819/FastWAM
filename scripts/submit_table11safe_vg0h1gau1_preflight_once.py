...
import submit_table11safe_vg0h1gau1_formal_once as common
...
LATCH = LAUNCH_ROOT / "submission-preflight-r1-latch.json"
ACK = LAUNCH_ROOT / "submission-preflight-r1-job-ack.json"
...
def main() -> int:
    ...
    common.require(
        COMMIT != common.UNPUBLISHED_COMMIT,
