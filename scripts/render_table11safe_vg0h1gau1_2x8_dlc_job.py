#!/usr/bin/env python3
"""Render, but never submit, the joint-safe Table11 VG0/H1/GAU1 2x8 job."""
...
WORKSPACE_ID = "270969"
LAUNCHER_PATH = "scripts/launch_table11safe_vg0h1gau1_2x8_dlc.sh"
...
def main() -> int:
    ...
    pod_count = 1 if args.preflight_one_step else 2
    envs = {
        "RUN_ID": args.run_id,
    ...
    request = {
        ...
        "Description": (
            ...
            + (
                ...
                "updates, 2 workers x 8 GPUs, world-16 global batch"
            )
        ),
        ...
        "Settings": {
            ...
            "Tags": {
                ...
                "topology": "1x8-world8" if args.preflight_one_step else "2x8-world16",
    ...
    document = {
        ...
        "batch_contract": {
            ...
            "replica_global_batch": 8 if args.preflight_one_step else 16,
