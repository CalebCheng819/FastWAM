...
SUBMITTER = EXPERIMENT / "submit-cache-r10-r25-egl-dedicated.py"
REQUEST = EXPERIMENT / "cache-create-job-r10-r25-egl-dedicated.json"
WORKER = EXPERIMENT / "cache-worker-r10-r25-egl-dedicated.sh"

SPEC = importlib.util.spec_from_file_location("p13_cache_r10", SUBMITTER)
MODULE = importlib.util.module_from_spec(SPEC)
assert SPEC.loader is not None
SPEC.loader.exec_module(MODULE)


class P13CacheR10SubmissionTest(unittest.TestCase):
    def test_request_is_priority_seven_and_uses_r25_graphics_contract(self):
        ...
        self.assertEqual(
            body["Settings"]["Tags"]["source_gate"],
            "bundle-clone-checkout-before-submit",
        )
        self.assertEqual(
    ...
    def test_worker_binds_gpu_zero_and_new_r10_runtime(self):
    ...
    def test_new_identity_and_real_fix_commit_are_consistent(self):
        ...
        self.assertEqual(
            ...
            "f8ac674c9be0fc187fc56d41842f338c6a7af2a1",
        )
        subprocess.run(
