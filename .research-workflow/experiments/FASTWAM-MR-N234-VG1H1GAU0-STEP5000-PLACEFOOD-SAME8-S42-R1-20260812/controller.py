...
EXPERIMENT_ID = "FASTWAM-MR-N234-VG1H1GAU0-STEP5000-PLACEFOOD-SAME8-S42-R1-20260812"
RUN_ID = "fastwam-gau0-placefood-same8-r1-20260813"
DISPLAY_NAME = "fw-gau0-placefood-same8-r1"
WORKSPACE_ID = "270969"
RESOURCE_ID = "quotaksvqq2oh2pg"
SOURCE_ROOT = Path("/oss-chengjuntao/artifacts/fastwam-nohash-source-snapshots/fastwam-gau0-placefood-same8-eval-20260813-r4")
...
LOCAL_ROOT = Path("/run/fastwam-dlc-submit-state/workspace-270969/gau0-placefood-same8-r1")
...
def request_body(source_commit: str) -> dict[str, Any]:
    ...
    return {
        ...
        "Settings": {
            ...
            "Tags": [{"Key": "experiment_id", "Value": EXPERIMENT_ID}, {"Key": "run_id", "Value": RUN_ID}],
        },
