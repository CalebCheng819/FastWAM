...
EXPERIMENT_ID = "FASTWAM-MR-N234-VG1H1GAU0-STEP5000-PLACEFOOD-SAME8-S42-R5-20260813"
RUN_ID = "fastwam-gau0-placefood-same8-r5-20260813"
DISPLAY_NAME = "fw-gau0-placefood-same8-r5"
WORKSPACE_ID = "270969"
RESOURCE_ID = "quotaksvqq2oh2pg"
SOURCE_ROOT = Path("/oss-chengjuntao/artifacts/fastwam-nohash-source-snapshots/fastwam-gau0-placefood-same8-eval-20260813-r14")
OUTPUT_ROOT = Path("/oss-chengjuntao/artifacts/fastwam-gau0-placefood-same8-eval-20260813-r5")
DURABLE_ROOT = Path("/oss-chengjuntao/artifacts/fastwam-gau0-placefood-same8-eval-20260813-r5-controller")
...
LOCAL_ROOT = Path("/run/fastwam-dlc-submit-state/workspace-270969/gau0-placefood-same8-r5")
...
PYTHON = Path("/cpfs/user/chengjuntao/venvs/mrb-8f865a3b-py312/bin/python")
PYTHON_TARGET = Path("/usr/local/bin/python")
PYTHON_RESOLVED_TARGET = Path("/usr/local/bin/python3.12")
PYTHON_EXTRA_ROOT = Path("/cpfs/user/chengjuntao/venvs/fastwam-gau0-eval-r5-py312-extra-20260813")
...
def worker_dependency_env() -> dict[str, str]:
    ...
    env.update({
        ...
        "LD_LIBRARY_PATH": str(NVIDIA_GRAPHICS_ROOT / "lib") + (
...
print("GAU0_WORKER_DEPENDENCY_PREFLIGHT_PASS")
'''
...
def validate_inputs(bindings: dict[str, Any]) -> None:
    ...
    for directory in (DATASET_ROOT, ROBOFACTORY_ROOT, CONTEXT_CACHE_DIR, MODEL_CACHE_ROOT, NVIDIA_GRAPHICS_ROOT, PYTHON_EXTRA_ROOT, BASELINE_ROOT):
        require_dir(directory)
    for key in ("checkpoint", "panel", "gau1_stats", "gau0_native_stats", "context"):
