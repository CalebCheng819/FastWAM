...
export FASTWAM_RUNTIME_EXPERIMENT_REL="${FASTWAM_RUNTIME_EXPERIMENT_REL:-.research-workflow/experiments/FASTWAM-MR-N234-VG1H1GAU0-STEP5000-PLACEFOOD-SAME8-S42-R23-20260817}"
export FASTWAM_RUNTIME_GENERATION="${FASTWAM_RUNTIME_GENERATION:-R23}"
