...
EXPERIMENT_REL="${FASTWAM_EXPERIMENT_REL_OVERRIDE:-.research-workflow/experiments/FASTWAM-MR-N234-VG1H1GAU0-STEP5000-PLACEFOOD-SAME8-S42-R14-20260814}"
...
scratch_root="$(mktemp -d "${FASTWAM_SCRATCH_TEMPLATE_OVERRIDE:-/tmp/fastwam-gau0-placefood-r14.XXXXXXXX}")"
cleanup() {
  rm -rf -- "${scratch_root}"
}
trap cleanup EXIT
