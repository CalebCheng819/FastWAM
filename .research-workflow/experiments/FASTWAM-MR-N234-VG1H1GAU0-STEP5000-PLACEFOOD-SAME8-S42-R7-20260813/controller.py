...
EXPERIMENT_ID = "FASTWAM-MR-N234-VG1H1GAU0-STEP5000-PLACEFOOD-SAME8-S42-R7-20260813"
RUN_ID = "fastwam-gau0-placefood-same8-r7-20260813"
DISPLAY_NAME = "fw-gau0-placefood-same8-r7"
WORKSPACE_ID = "270969"
RESOURCE_ID = "quotaksvqq2oh2pg"
SOURCE_ROOT = Path("/oss-chengjuntao/artifacts/fastwam-nohash-source-snapshots/fastwam-gau0-placefood-same8-eval-20260813-r16")
OUTPUT_ROOT = Path("/oss-chengjuntao/artifacts/fastwam-gau0-placefood-same8-eval-20260813-r7")
DURABLE_ROOT = Path("/oss-chengjuntao/artifacts/fastwam-gau0-placefood-same8-eval-20260813-r7-controller")
...
LOCAL_ROOT = Path("/run/fastwam-dlc-submit-state/workspace-270969/gau0-placefood-same8-r7")
