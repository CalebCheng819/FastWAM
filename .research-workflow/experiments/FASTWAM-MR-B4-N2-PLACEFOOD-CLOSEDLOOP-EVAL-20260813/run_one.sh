...
panel_root="$script_dir/../FASTWAM-MR-FT-ACT-N2-PLACEFOOD-TRAINLAYOUT-EVAL-R5-20260813/panels"
panel="$panel_root/${split}8.json"
...
checkpoint=/oss-chengjuntao/artifacts/fastwam-mr-n234-b4-phase-gripcontact-actft-s42-24g-r4-20260812/checkpoints/weights/step_002500.pt
