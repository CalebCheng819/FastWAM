...
EXPERIMENT_ID = "FASTWAM-MR-N234-VG1H1GAU0-STEP5000-PLACEFOOD-SAME8-S42-R3-20260813"
RUN_ID = "fastwam-gau0-placefood-same8-r3-20260813"
DISPLAY_NAME = "fw-gau0-placefood-same8-r3"
WORKSPACE_ID = "270969"
RESOURCE_ID = "quotaksvqq2oh2pg"
SOURCE_ROOT = Path("/oss-chengjuntao/artifacts/fastwam-nohash-source-snapshots/fastwam-gau0-placefood-same8-eval-20260813-r11")
OUTPUT_ROOT = Path("/oss-chengjuntao/artifacts/fastwam-gau0-placefood-same8-eval-20260813-r3")
DURABLE_ROOT = Path("/oss-chengjuntao/artifacts/fastwam-gau0-placefood-same8-eval-20260813-r3-controller")
...
LOCAL_ROOT = Path("/run/fastwam-dlc-submit-state/workspace-270969/gau0-placefood-same8-r3")
...
def input_bindings() -> dict[str, Any]:
    validate_python()
    for directory in (DATASET_ROOT, ROBOFACTORY_ROOT, CONTEXT_CACHE_DIR, MODEL_CACHE_ROOT, NVIDIA_GRAPHICS_ROOT, BASELINE_ROOT):
