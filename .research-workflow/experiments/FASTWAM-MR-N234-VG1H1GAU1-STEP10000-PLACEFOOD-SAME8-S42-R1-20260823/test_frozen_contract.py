...
class FrozenContractTests(unittest.TestCase):
    def test_renderer_pins_one_worker_eight_gpu_priority_seven(self) -> None:
        ...
        self.assertEqual(envs["FASTWAM_ATTEMPT_ID"], "attempt-003")
        self.assertEqual(document["run_id"], "fastwam-gau1-step10k-placefood-same8-r3-20260823")
        self.assertEqual(
            envs["FASTWAM_OUTPUT_ROOT"],
            "/oss-chengjuntao/artifacts/fastwam-gau1-step10k-placefood-same8-eval-20260823-r3",
        )
