#!/usr/bin/env python3
"""Audit or exactly-once submit the complete-GLVND P13 R8 cache job."""
...
DISPLAY_NAME = "fastwam-p13-metric-cache-s42-8g-r8-complete-glvnd-dedicated-20260817"
RUN_ID = DISPLAY_NAME
OUTPUT_ROOT = (
    "/oss-chengjuntao/artifacts/"
    "fastwam-placefood-metric-geometry-60x80-s42-v1-"
    "r8-complete-glvnd-dedicated-20260817"
)
SOURCE_REVISION = "c2b7380d02ad0412733eaf72714de2b207f5bd4e"
SOURCE_BUNDLE = (
    "/oss-chengjuntao/artifacts/fastwam-p13-runtime-20260817-r8-complete-glvnd/"
    "FastWAM-p13-r8-source-c2b7380.bundle"
)
VULKAN_LOADER = BASE.VULKAN_LOADER
WORKER_COMMAND = (
    "exec /bin/bash "
    "/oss-chengjuntao/artifacts/fastwam-p13-runtime-20260817-r8-complete-glvnd/"
    "cache-worker-r8-complete-glvnd-dedicated.sh"
)
...
def main() -> None:
    ...
    base = {
        "schema": "fastwam-p13-dlc-submit-r8-v1",
        ...
        "graphics_gate": "complete-glvnd-abi-before-real-environment",
