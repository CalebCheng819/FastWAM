#!/usr/bin/env python3
"""Audit or exactly-once submit the profile-ordered P13 R7 cache job."""
...
DISPLAY_NAME = "fastwam-p13-metric-cache-s42-8g-r7-profile-ordered-dedicated-20260817"
RUN_ID = DISPLAY_NAME
OUTPUT_ROOT = (
    "/oss-chengjuntao/artifacts/"
    "fastwam-placefood-metric-geometry-60x80-s42-v1-"
    "r7-profile-ordered-dedicated-20260817"
)
SOURCE_REVISION = "6b02e6518e0d7d718d5c5a060accd6386fea548e"
SOURCE_BUNDLE = (
    "/oss-chengjuntao/artifacts/fastwam-p13-runtime-20260817-r7/"
    "FastWAM-p13-r7-source-6b02e65.bundle"
)
VULKAN_LOADER = BASE.VULKAN_LOADER
WORKER_COMMAND = (
    "exec /bin/bash /oss-chengjuntao/artifacts/fastwam-p13-runtime-20260817-r7/"
    "cache-worker-r7-profile-ordered-dedicated.sh"
)
...
def main() -> None:
    ...
    base = {
        "schema": "fastwam-p13-dlc-submit-r7-v1",
        ...
        "graphics_gate": "profile-before-import-real-environment",
