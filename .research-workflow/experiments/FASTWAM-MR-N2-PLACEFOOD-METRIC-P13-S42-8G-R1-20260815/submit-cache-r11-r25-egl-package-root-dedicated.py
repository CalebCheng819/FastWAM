#!/usr/bin/env python3
"""Audit or exactly-once submit the package-root-corrected P13 R11 cache job."""
...
DISPLAY_NAME = "fastwam-p13-metric-cache-s42-8g-r11-r25-egl-package-root-dedicated-20260817"
RUN_ID = DISPLAY_NAME
OUTPUT_ROOT = (
    "/oss-chengjuntao/artifacts/"
    "fastwam-placefood-metric-geometry-60x80-s42-v1-"
    "r11-r25-egl-package-root-dedicated-20260817"
)
SOURCE_REVISION = "70aabc72654da6c3a1ac88e8780b58805f75443a"
SOURCE_BUNDLE = (
    "/oss-chengjuntao/artifacts/fastwam-p13-runtime-20260817-r11-r25-egl-package-root/"
    "FastWAM-p13-r11-source-70aabc7.bundle"
)
VULKAN_LOADER = BASE.VULKAN_LOADER
GRAPHICS_GATE_TAG = "r25-egl-package-parent-before-real-environment"
WORKER_COMMAND = (
    "exec /bin/bash "
    "/oss-chengjuntao/artifacts/fastwam-p13-runtime-20260817-r11-r25-egl-package-root/"
    "cache-worker-r11-r25-egl-package-root-dedicated.sh"
)
...
def main() -> None:
    ...
    base = {
        "schema": "fastwam-p13-dlc-submit-r11-v1",
        ...
        "graphics_gate": "r25-egl-package-parent-before-real-environment",
        "source_gate": "bundle-clone-checkout-before-submit",
