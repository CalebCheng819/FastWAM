#!/usr/bin/env python3
"""Audit or exactly-once submit the corrected-source P13 R10 cache job."""
...
DISPLAY_NAME = "fastwam-p13-metric-cache-s42-8g-r10-r25-egl-dedicated-20260817"
RUN_ID = DISPLAY_NAME
OUTPUT_ROOT = (
    "/oss-chengjuntao/artifacts/"
    "fastwam-placefood-metric-geometry-60x80-s42-v1-"
    "r10-r25-egl-dedicated-20260817"
)
SOURCE_REVISION = "f8ac674c9be0fc187fc56d41842f338c6a7af2a1"
SOURCE_BUNDLE = (
    "/oss-chengjuntao/artifacts/fastwam-p13-runtime-20260817-r10-r25-egl/"
    "FastWAM-p13-r10-source-f8ac674c.bundle"
)
...
WORKER_COMMAND = (
    "exec /bin/bash "
    "/oss-chengjuntao/artifacts/fastwam-p13-runtime-20260817-r10-r25-egl/"
    "cache-worker-r10-r25-egl-dedicated.sh"
)
...
def main() -> None:
    ...
    base = {
        "schema": "fastwam-p13-dlc-submit-r10-v1",
